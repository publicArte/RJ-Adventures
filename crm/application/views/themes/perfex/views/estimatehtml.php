...
<div class="col-md-12 page-pdf-html-logo">
   ...
   <a href="<?php echo site_url('clients/estimates/'); ?>" class="btn btn-default pull-right go-to-portal">
...
<div class="panel_s mtop20">
   <div class="panel-body">
      <div class="col-md-10 col-md-offset-1">
         <div class="row">
            <div class="col-md-6">
               <div class="mtop10 display-block estimate-html-status">
                  ...
                  <tbody>
                     ...
                     <?php
                        foreach($items->taxes() as $tax){
                            echo '<tr class="tax-area"><td class="bold">'.$tax['taxname'].' ('.app_format_number($tax['taxrate']).'%)</td><td>'.format_money($tax['total_tax'], $estimate->symbol).'</td></tr>';
                        }
                        ?>
