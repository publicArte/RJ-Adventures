...
class Migration_Version_101 extends CI_Migration
{
    ...
    public function up()
    {
        ...
        $this->dbforge->add_column(db_prefix().'clients', $fields);
        ...
        $this->dbforge->add_column(db_prefix().'invoicepaymentsmodes', $fields);
        ...
        $this->dbforge->add_column(db_prefix().'invoicepaymentrecords', $fields);
        ...
        $this->dbforge->add_column(db_prefix().'invoices', $fields);
