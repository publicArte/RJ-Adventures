...
*
*/
define('APP_BASE_URL', 'http://rjtransfersadventures.com/crm/');
...
*/
define('APP_ENC_KEY', '0e2c1478dcbfdfe9668f3168bac313a6');
 ...
 */
define('APP_DB_USERNAME', 'globalma_rjcrm');
/**
 * The password used to connect to the database
 */
define('APP_DB_PASSWORD', '12345');
/**
 * The name of the database you want to connect to
 */
define('APP_DB_NAME', 'globalma_rjcrm');
