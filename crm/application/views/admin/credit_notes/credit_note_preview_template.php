                           ...
                           <tbody>
                              ...
                              <?php
                                 foreach($items->taxes() as $tax){
                                   echo '<tr class="tax-area"><td class="bold">'.$tax['taxname'].' ('.app_format_number($tax['taxrate']).'%)</td><td>'.format_money($tax['total_tax'], $credit_note->symbol).'</td></tr>';
                                 }
                                 ?>
                              ...
                              <tr>
                                 ...
                                 <td>
                                    <?php echo '-' . format_money($credit_note->total_refunds, $credit_note->symbol); ?>
                                 </td>
                              </tr>
                              <?php } ?>
                              <tr>
               ...
               <table class="table table-bordered no-mtop">
                  ...
                  <tbody>
                     ...
                     <tr>
                        ...
                        <td>
                           <?php echo format_money($refund['amount'], $credit_note->symbol); ?>
                        </td>
                        <td>
