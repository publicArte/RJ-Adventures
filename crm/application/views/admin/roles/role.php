                        ...
                        <tr>
                           ...
                           <td class="text-center">
                              <?php if($permission_condition['view'] == true){
                                 $statement = '';
                                 if(isset($role)){
                                   if(total_rows(db_prefix().'role_permissions',array('roleid'=>$role->roleid,'permissionid'=>$permission['permissionid'],'can_view'=>1)) > 0){
                                     $statement = 'checked';
                                   }

                                   if(total_rows(db_prefix().'role_permissions',array('roleid'=>$role->roleid,'permissionid'=>$permission['permissionid'],'can_view_own'=>1)) > 0){
                                     $statement = 'disabled';
                                   }
                                 }
                                 ?>
                           ...
                           <td class="text-center">
                              <?php if($permission_condition['create'] == true){
                                 $statement = '';
                                 if(isset($role)){
                                   if(total_rows(db_prefix().'role_permissions',array('roleid'=>$role->roleid,'permissionid'=>$permission['permissionid'],'can_create'=>1)) > 0){
                                     $statement = 'checked';
                                   }
                                 }
                                 ?>
                           ...
                           <td class="text-center">
                              <?php if($permission_condition['edit'] == true){
                                 $statement = '';
                                 if(isset($role)){
                                   if(total_rows(db_prefix().'role_permissions',array('roleid'=>$role->roleid,'permissionid'=>$permission['permissionid'],'can_edit'=>1)) > 0){
                                     $statement = 'checked';
                                   }
                                 }
                                 ?>
                           ...
                           <td class="text-center">
                              <?php if($permission_condition['delete'] == true){
                                 $statement = '';
                                 if(isset($role)){
                                   if(total_rows(db_prefix().'role_permissions',array('roleid'=>$role->roleid,'permissionid'=>$permission['permissionid'],'can_delete'=>1)) > 0){
                                     $statement = 'checked';
                                   }
                                 }
                                 ?>
