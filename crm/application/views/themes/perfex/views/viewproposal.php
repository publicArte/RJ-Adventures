...
$items = get_items_table_data($proposal, 'proposal')
            ...
            <tbody>
               ...
               <?php
                  foreach($items->taxes() as $tax){
                   echo '<tr class="tax-area"><td class="bold">'.$tax['taxname'].' ('.app_format_number($tax['taxrate']).'%)</td><td>'.format_money($tax['total_tax'], $proposal->symbol).'</td></tr>';
                  }
                  ?>
   ...
   <?php }
      ...
      ?>
   <div class="<?php if(!is_mobile()){echo 'mtop30';} ?>">
    <div class="row">
         <div class="col-md-3">
            <div class="mbot30">
    ...
    <div class="top" data-sticky data-sticky-class="preview-sticky-header">
      ...
      <div class="row">
         ...
         <div class="col-md-4 proposal-right">
            <div class="inner mtop20 proposal-html-tabs"<?php if(!is_mobile()){ ?> data-sticky data-margin-top="50" <?php } ?>>
