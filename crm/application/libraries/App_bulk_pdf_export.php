...
class App_bulk_pdf_export
{
    ...
    private function estimates()
    {
        ...
        if (!$this->can_view) {
            $this->ci->db->where(get_estimates_where_sql_for_staff(get_staff_user_id()));
        }
    ...
    private function invoices()
    {
        ...
        if (!$this->can_view) {
            $this->ci->db->where(get_invoices_where_sql_for_staff(get_staff_user_id()));
        }
    ...
    public function proposals()
    {
        ...
        if (!$this->can_view) {
            $this->ci->db->where(get_proposals_sql_where_staff(get_staff_user_id()));
        }
