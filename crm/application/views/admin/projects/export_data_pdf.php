...
$html .= '<b>' . _l('project_overview_expenses') . ': </b>' . format_money(sum_from_table(db_prefix().'expenses', ['where' => ['project_id' => $project->id], 'field' => 'amount']), $project->currency_data->symbol) . '<br />';
// Billable expenses + money
$html .= '<b>' . _l('project_overview_expenses_billable') . ': </b>' . format_money(sum_from_table(db_prefix().'expenses', ['where' => ['project_id' => $project->id, 'billable' => 1], 'field' => 'amount']), $project->currency_data->symbol) . '<br />';
// Billed expenses + money
$html .= '<b>' . _l('project_overview_expenses_billed') . ': </b>' . format_money(sum_from_table(db_prefix().'expenses', ['where' => ['project_id' => $project->id, 'invoiceid !=' => 'NULL', 'billable' => 1], 'field' => 'amount']), $project->currency_data->symbol) . '<br />';
// Unbilled expenses + money
$html .= '<b>' . _l('project_overview_expenses_unbilled') . ': </b>' . format_money(sum_from_table(db_prefix().'expenses', ['where' => ['project_id' => $project->id, 'invoiceid IS NULL', 'billable' => 1], 'field' => 'amount']), $project->currency_data->symbol) . '<br />';
