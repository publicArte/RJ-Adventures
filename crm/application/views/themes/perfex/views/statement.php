                        ...
                        <div class="col-md-12">
                           ...
                           <div class="table-responsive">
                              <table class="table table-bordered table-striped">
                                 ...
                                 <tbody>
                                    <tr>
                                       ...
                                       <td class="text-right"><?php echo app_format_number($statement['beginning_balance']); ?></td>
                                       <td></td>
                                       <td class="text-right"><?php echo app_format_number($statement['beginning_balance']); ?></td>
                                    </tr>
                                    <?php
                                    ...
                                    <tr>
                                       ...
                                       <td>
                                          ...
                                          if(isset($data['invoice_id'])) {
                                             ...
                                             echo _l('statement_credits_applied_details',array(
                                               ...
                                               app_format_number($data['credit_amount']),
                                       ...
                                       <td class="text-right">
                                          <?php
                                          if(isset($data['invoice_id'])) {
                                           echo app_format_number($data['invoice_amount']);
                                          } else if(isset($data['credit_note_id'])) {
                                           echo app_format_number($data['credit_note_amount']);
                                        }
                                      ?>
                                   </td>
                                   <td class="text-right">
                                    ...
                                    if(isset($data['payment_id'])) {
                                     echo app_format_number($data['payment_total']);
                                  }
                                  ?>
                               </td>
                               <td class="text-right">
                              ...
                              if(!isset($data['credit_id'])){
                                 echo app_format_number($tmpBeginningBalance);
                              }
                           ?>
                        </td>
                     </tr>
