	...
	<table class="table table-bordered" id="system-info">
		...
		<tbody>
			...
			<tr>
				...
				<td>
					<?php
					echo ini_get('max_input_vars') ? ini_get('max_input_vars') : 'N/A';
					?>
				</td>
			...
			<tr>
				...
				<td>
					<?php
					echo ini_get('upload_max_filesize') ? ini_get('upload_max_filesize') : 'N/A';
					?>
				</td>
			...
			<tr>
				...
				<td>
					<?php
					echo ini_get('post_max_size') ? ini_get('post_max_size') : 'N/A';
					?>
				</td>
			...
			<tr>
				...
				<td>
					<?php
					echo ini_get('max_execution_time') ? ini_get('max_execution_time') : 'N/A';
					?>
				</td>
			...
			<tr>
				...
				<td>
					<?php
					echo ini_get('memory_limit') ? ini_get('memory_limit') : 'N/A';
					?>
				</td>
			...
			<tr>
				...
				<td>
					...
					if ($url_f_open != "1"
						...
						echo "<span class='text-danger'>Allow_url_fopen is not enabled! (Value: $allow_url_fopen)</span>";
				} else {
					echo "<span class='text-success'>Enabled</span>";
				}
				?>
		...
		<tr>
			...
			<td>
				...
				if ($CloudFlareHeader && !empty($CloudFlareHeader)) {
					echo "Yes";
				} else {
					echo "No";
				}
